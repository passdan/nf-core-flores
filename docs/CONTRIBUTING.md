...
# `nf-core/flores`: Contributing guidelines

Hi there!
Thanks for taking an interest in improving nf-core/flores.

This page describes the recommended nf-core way to contribute to both nf-core/flores and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of nf-core/flores.

> [!NOTE]
> If you need help using or modifying nf-core/flores, ask on the nf-core Slack [#flores](https://nfcore.slack.com/channels/flores) channel ([join our Slack here](https://nf-co.re/join/slack)).
...
- [ ] Check whether a GitHub [issue](https://github.com/nf-core/flores/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [nf-core/flores repository](https://github.com/nf-core/flores) to your GitHub account.
...
For further information and help, see the [nf-core/flores documentation](https://nf-co.re/flores/usage) or ask on the nf-core [#flores](https://nfcore.slack.com/channels/flores) Slack channel ([join our Slack here](https://nf-co.re/join/slack)).

### GitHub Codespaces

You can contribute to nf-core/flores without installing a local development environment on your machine by using [GitHub Codespaces](https://github.com/codespaces).
...
To get started, open the repository in [Codespaces](https://github.com/nf-core/flores/codespaces).
...
nf-core semi-standardises how you write code and other contributions to make the nf-core/flores code and processing logic more understandable for new contributors and to ensure quality.
